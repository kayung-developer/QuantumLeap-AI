...
<div align="center">
  <img src="public/app.png" alt="QuantumLeap AI Trader Logo" width="120" />
...
<div align="center">
  <img src="images/dashboard.png" alt="QuantumLeap Dashboard" width="800px" style="border-radius: 10px; box-shadow: 0 10px 30px rgba(0,0,0,0.3);" />
...
<table width="100%">
  <tr>
    <td width="50%" align="center">
      <img src="images/strategy-builder.png" alt="Visual Strategy Builder" style="border-radius: 10px; box-shadow: 0 5px 15px rgba(0,0,0,0.2);">
      <p><em>The intuitive, node-based <strong>Visual Strategy Builder</strong>.</em></p>
    </td>
    <td width="50%" align="center">
      <img src="images/strategy-lab.png" alt="Strategy Laboratory" style="border-radius: 10px; box-shadow: 0 5px 15px rgba(0,0,0,0.2);">
      <p><em>The <strong>Strategy Lab</strong>, showing backtest optimization results and the AI Sensei.</em></p>
    </td>
  </tr>
  <tr>
    <td width="50%" align="center">
      <img src="images/wallet.png" alt="Wallet Page" style="border-radius: 10px; box-shadow: 0 5px 15px rgba(0,0,0,0.2);">
      <p><em>The unified <strong>Wallet Page</strong>, displaying both custodial and non-custodial (MT5) balances.</em></p>
    </td>
    <td width="50%" align="center">
      <img src="images/bots.png" alt="My Bots Page" style="border-radius: 10px; box-shadow: 0 5px 15px rgba(0,0,0,0.2);">
