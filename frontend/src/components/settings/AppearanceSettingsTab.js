            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {themes.map((t) => (
                    <button
                        ...
                        className={`
                          p-6 rounded-lg border-2 transition-colors flex flex-col items-center justify-center
                          ${theme === t.name
                            ? 'border-accent bg-accent/10 dark:bg-secondary'
                            : 'border-light-border bg-light-primary hover:border-gray-400 dark:border-border-color dark:bg-primary dark:hover:border-gray-600'}
                        `}
                    >
