            ...
            <div className="lg:col-span-2">
                ...
                <div className="space-y-4">
                    {keysResponse?.data.map(key => (
                        <div key={key.id} className="flex items-center justify-between p-4 bg-light-primary dark:bg-primary rounded-lg border border-light-border dark:border-border-color">
                            <div className="flex items-center">
                                <FaKey className="text-accent mr-4" />
                                <div>
                                    <p className="font-bold text-light-text dark:text-white capitalize">{key.exchange}</p>
                                    <p className="text-xs text-light-muted dark:text-light-gray font-mono">{key.api_key_masked}</p>
                                </div>
                                <span className="ml-4 text-xs font-bold uppercase bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300 px-2 py-1 rounded-full">{key.asset_class}</span>
                            </div>
