    ...
    return (
        <div>
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-3xl font-bold text-white">Superuser Dashboard</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
                ...
                <Card className="bg-red-900/50 border-danger">
                     <h2 className="text-xl font-semibold text-white mb-4 flex items-center"><FaExclamationTriangle className="mr-2"/>Emergency Controls</h2>
                     <p className="text-sm text-red-200 mb-4">This will stop all running bots immediately. Use only in a critical system-wide emergency.</p>
                     <Button variant="danger" className="w-full" onClick={() => setModal({ type: 'kill_switch' })}>Activate Kill Switch</Button>
                </Card>
            </div>
