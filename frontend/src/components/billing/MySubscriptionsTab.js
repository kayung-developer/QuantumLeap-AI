                ...
                <table className="w-full text-sm text-left text-light-muted dark:text-light-gray">
                    ...
                    <tbody className="divide-y divide-light-border dark:divide-border-color">
                        {subscriptions?.data.map(sub => (
                            <tr key={sub.id} className="hover:bg-gray-50 dark:hover:bg-secondary">
                                <td className="px-4 py-3 font-semibold text-light-text dark:text-white">{sub.strategy_bot_name}</td>
                                <td className="px-4 py-3 font-mono">{sub.strategy_bot_symbol}</td>
