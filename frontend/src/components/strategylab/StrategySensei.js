...
const ChatMessage = ({ message }) => {
    ...
    return (
        ...
        >
            <div className={`p-3 rounded-lg max-w-xs md:max-w-md shadow-sm ${isUser ? 'bg-accent text-white' : 'bg-light-secondary dark:bg-secondary'}`}>
                {/* Use whitespace-pre-wrap to respect newlines in the AI's response */}
